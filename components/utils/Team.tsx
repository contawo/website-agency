        ...
        <section className={styles.nest}>
            <div className={styles.nestHead}>
                ...
                <div className={styles.qCont}>
                    ...
                    <p className={styles.qDescription}>Great web design without functionality is like a sports car with no engine.</p>
            ...
            <div className={styles.nestBody}>
                ...
                <p className={styles.bDescription2}>Our team is dedicated to delivering exceptional customer service and providing ongoing support to ensure that our clients websites continue to perform at the highest level.</p>
            </div>
        </section>
    )
}
